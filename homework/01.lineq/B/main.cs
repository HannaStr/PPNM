...
class main{
    ...
    public static void check_inverse(){
        WriteLine();
		WriteLine("............................................");
		WriteLine("TASK 1: Calculate the inverse of a matrix A.");
		WriteLine("````````````````````````````````````````````");
        ...
        //calculate inverse B
        matrix B = lin_system.inverse(A);
        WriteLine("\nc) The inverse matrix B is:");
        B.print();
        
        //check that AB = I (where I is an identity matrix)
        matrix AB = A*B;
